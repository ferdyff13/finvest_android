...
public class ConfirmCheckPinResponse extends GenericResponse implements Serializable {

    @SerializedName("data")
    @Expose
    private ConfirmCheckPin data;
     ...
     * @return The data
     */
    public ConfirmCheckPin getData() {
        return data;
    }
     ...
     * @param data The data
     */
    public void setData(ConfirmCheckPin data) {
        this.data = data;
    }
