...
/**
 * Created by pandu.abbiyuarsyah on 18/01/2018.
 */

public class TermsAndConditionViseePayFragment extends BaseFragment {

    public static final String TAG = TermsAndConditionViseePayFragment.class.getSimpleName();

    public static void showFragment(BaseActivity sourceActivity) {
        if (!sourceActivity.isFragmentNotNull(TAG)) {
            FragmentTransaction fragmentTransaction = sourceActivity.getSupportFragmentManager().beginTransaction();
            fragmentTransaction.setCustomAnimations(R.anim.enter, R.anim.exit, R.anim.pop_enter, R.anim.pop_exit);
            fragmentTransaction.replace(R.id.container, new TermsAndConditionViseePayFragment(), TAG);
    ...
    public void onResume() {
        super.onResume();
        ((WalletActivity) getActivity()).setActionBarTitle("Syarat dan Ketentuan");
    }
